        ...
        <div class="wrap">
            <div class="form-wrap">
                <div class="button-wrap">
                    <aside class="togglebtn">LOG IN</aside>
                </div>
                ...
                <form id="login" action="login" name="input" class="input-group" method="post">
                    ...
                    <input type="password" name="pw" id="user_pw" class="input-field" placeholder="비밀번호 입력">
                    <input type="checkbox" class="checkbox" name="autoLogin" style="margin-top:3px; padding-top: -50px;"><br><span>Remember Password</span>
                    <a href="id_find" class="find" style="text-decoration: none; padding-left:50px; color:black;">id/pw 찾기</a>
                    <button type="button" class="btn btn-primary" onclick="login()" style="height: 40px; width: 140px; margin-top: 30px;
                    margin-right:20px; ">Login</button>
                    <input type="button" onclick="Logout(); return false;" value="로그아웃">
                </form>
