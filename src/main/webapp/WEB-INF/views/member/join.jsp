...
<body>
  <!--  div class="container">--><!-- 좌우측의 공간 확보 -->
            ...
            <form class="form-horizontal" id="signUpForm" role="form" method="post" action="join" style="padding-left: 80px">
              
                <div class="form-group" id="divId">
                    <label for="inputId" class="col-lg-2 control-label">아이디</label>
                    <div class="col-lg-10">
                        <input type="text" id="id" name="user_id" class="form-control onlyAlphabetAndNumber"
                        data-rule-required="true" placeholder="14자 이하의 영문,숫자" maxlength="30">
                    </div>
